export const expense = () => `
  with par as (select ? as vdate from dual),
       types as (select 'EX001' id, 'Interest' descip
                 from dual
                 union all
                 select 'EX002' id, 'commission and Fee' descip
                 from dual
                 union all
                 select 'EX003' id, 'Provision NPL' descip
                 from dual
                 union all
                 select 'EX004' id, 'Gain Loss trading available' descip
                 from dual
                 union all
                 select 'EX005' id, 'Others' descip
                 from dual
                 union all
                 select 'EX006' id, 'Salary and Wages' descip
                 from dual
                 union all
                 select 'EX007' id, 'Admin expenses' descip
                 from dual
                 union all
                 select 'EX008' id, 'Depreciation' descip
                 from dual
                 union all
                 select 'EX009' id, 'Profit tax' descip
                 from dual),
